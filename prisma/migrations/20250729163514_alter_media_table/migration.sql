/*
  ...
  - The values [WEB] on the enum `MediaType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "MediaType_new" AS ENUM ('IMAGE', 'VIDEO', 'AUDIO', 'HTML', 'RSS', 'DOCUMENT');
